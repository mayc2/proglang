...
public class IdealJailStar extends UniversalActor  {
	public static void main(String args[]) {
		...
		IdealJailStar instance = (IdealJailStar)new IdealJailStar(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new IdealJailStar(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return IdealJailStar.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new IdealJailStar(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return IdealJailStar.getReferenceByLocation(new UAL(ual)); }
	public IdealJailStar(boolean o, UAN __uan)	{ super(false,__uan); }
	public IdealJailStar(boolean o, UAL __ual)	{ super(false,__ual); }
	public IdealJailStar(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public IdealJailStar(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public IdealJailStar(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public IdealJailStar()		{  }
	public IdealJailStar(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "distributed.IdealJailStar", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public IdealJailStar self;
		public void updateSelf(ActorReference actorReference) {
			((IdealJailStar)actorReference).setUAL(getUAL());
			((IdealJailStar)actorReference).setUAN(getUAN());
			self = new IdealJailStar(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "distributed.IdealJailStar$State" );
