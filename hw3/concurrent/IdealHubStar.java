...
public class IdealHubStar extends UniversalActor  {
	public static void main(String args[]) {
		...
		IdealHubStar instance = (IdealHubStar)new IdealHubStar(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new IdealHubStar(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return IdealHubStar.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new IdealHubStar(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return IdealHubStar.getReferenceByLocation(new UAL(ual)); }
	public IdealHubStar(boolean o, UAN __uan)	{ super(false,__uan); }
	public IdealHubStar(boolean o, UAL __ual)	{ super(false,__ual); }
	public IdealHubStar(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public IdealHubStar(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public IdealHubStar(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public IdealHubStar()		{  }
	public IdealHubStar(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "concurrent.IdealHubStar", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public IdealHubStar self;
		public void updateSelf(ActorReference actorReference) {
			((IdealHubStar)actorReference).setUAL(getUAL());
			((IdealHubStar)actorReference).setUAN(getUAN());
			self = new IdealHubStar(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "concurrent.IdealHubStar$State" );
		...
		public void outputHubStars(Vector stars) {
			{
				Token token_2_0 = new Token();
				// findHubStars(stars)
				{
					Object _arguments[] = { stars };
					Message message = new Message( self, self, "findHubStars", _arguments, null, token_2_0 );
		...
		public Vector findHubStars(Vector stars) {
